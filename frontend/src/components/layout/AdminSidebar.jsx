...
import { Boxes, FileSpreadsheet, History, LayoutDashboard, LogOut, QrCode, Users } from 'lucide-react';
...
export default function AdminSidebar({
  ...
  const menuItems = [
    ...
    { to: '/admin/pengguna', label: 'Kelola Pengguna', icon: Users, badge: null },
  ];
